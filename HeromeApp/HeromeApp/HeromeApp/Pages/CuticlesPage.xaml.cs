...
namespace HeromeApp.Pages
{
	...
	public partial class CuticlesPage : ContentPage
	{
		public CuticlesPage ()
		{
			InitializeComponent ();
			...
			this.questionaire.BindingContext = new HeromeQuestionaireModel(questions, results, "Meer info over Nagelriemadvies");
		}
